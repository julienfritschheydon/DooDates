...
- [ ] **Tests Gemini** 
      ON a fait beaucoup de refactoring, notamment la séparation des fichiers Gemini et des produits. Le résultat, c'est que Gemini ne fonctionne pas très bien. Regarde un exemple: 
      Ta mission aujourd'hui est de faire en sorte que l'on revienne à la qualité d'avant.
      Pour cela, nous avons les tests Gemini @-Tests-Guide.md#L42-201 
      Il est très important :
        1. De toujours savoir ce que Gemini répond vs ce que notre code fait, car il peut arriver que le code masque une très mauvaise réponse
        2. Il faut tester l'expérience de l'utilisateur
            3. Pour le moment, nous devons nous concentrer uniquement sur les sondages de dates.
    - [ ] **Tests Gemini Réels** 
  ...
  - [ ] **Prototype Aide aux Devoirs** (2h + 1h)
    - [ ] Interface quizz simple (photo → questions) sur la base des fonctions des formulaires
