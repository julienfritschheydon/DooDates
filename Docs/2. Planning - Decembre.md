...
### 📌 JEUDI 5 DÉCEMBRE - JOUR 4
  ...
  - [ ] **Tests de régression post-scission** (2h) ⭐ **PRIORITÉ APRÈS SCISSION**
    ...
    **New Product-Specific Tests**
    - [/] Create tests/e2e/products/date-polls/navigation.spec.ts
    - [/] Create tests/e2e/products/form-polls/navigation.spec.ts
    - [/] Create tests/e2e/products/availability-polls/navigation.spec.ts
    - [x] Create tests/e2e/products/cross-product/product-isolation.spec.ts
    - [/] Create date-polls navigation tests
    - [/] Create form-polls navigation tests
    - [/] Create availability-polls navigation tests
    - [ ] Create cross-product isolation tests
