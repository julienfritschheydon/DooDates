...
export const MISTRAL_FUNCTIONS = [
  {
    ...
    function: {
      ...
      description:
        "Crée un brouillon de sondage à partir des informations extraites de la conversation",
      parameters: {
        type: "object",
        properties: {
          title: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Demande une clarification à l'utilisateur quand les informations sont incomplètes ou ambiguës",
      parameters: {
        type: "object",
        properties: {
          question: {
...
export class FunctionHandler {
  ...
  private inferGranularity(timeSlots: any): number {
    ...
    const durations = Object.values(timeSlots)
      .flat()
      .map((slot: any) => {
...
export class AIService {
  ...
  async fallbackToSimpleExtraction(userMessage: string): Promise<any> {
    ...
    const datePattern =
      /\d{1,2}\/\d{1,2}|\d{1,2}\s+(janvier|février|mars|avril|mai|juin|juillet|août|septembre|octobre|novembre|décembre)/gi;
