# Jeu de Tests - Formats Questionnaires Variés

Ce fichier contient différents formats que les utilisateurs pourraient copier-coller.
...
### Q3. Commentaires libres (Réponse libre)
...
- Neutre (3/5)
- Insatisfait (2/5)
- Très insatisfait (1/5)

### Q2. Vos suggestions d'amélioration (réponse libre)
...
### Q1bis. Si NON, pourquoi ? (texte libre)
...
## Format 9 : Espaces et indentations variables
