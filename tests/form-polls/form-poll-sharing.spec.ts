      ...
      const sharingData = {
        ...
        sharingOptions: {
          ...
          socialMedia: {
            facebook: {
              enabled: true,
              url: 'https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent('https://doodates.app/poll/test-sharing')
            },
            twitter: {
              enabled: true,
              url: 'https://twitter.com/intent/tweet?url=' + encodeURIComponent('https://doodates.app/poll/test-sharing') + '&text=Votez maintenant!'
            },
            linkedin: {
              enabled: true,
              url: 'https://www.linkedin.com/sharing/share-offsite/?url=' + encodeURIComponent('https://doodates.app/poll/test-sharing')
            }
          },
          email: {
            enabled: true,
