...
test.describe("Gemini API - Tests Réels", () => {
  ...
  test("✅ Test connexion Gemini API réelle @real-gemini", async ({
    page,
    browserName,
  }, testInfo) => {
    ...
    await page
      ...
      .fill("Crée un sondage simple avec 2 dates pour tester Gemini");
  ...
  test("✅ Test quota tracking avec appel réel @real-gemini", async ({ page }) => {
    ...
    const noQuotaError = await page
      .locator("text=quota exceeded")
