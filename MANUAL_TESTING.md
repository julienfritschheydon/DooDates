...
- *Note : J'ai ajouté une instruction "EXCEPTION" pour forcer les choix multiples, mais ça résiste.*
...
- *J'ai renforcé le parsing JSON. Ce test devrait passer maintenant.*
