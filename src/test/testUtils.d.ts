...
export declare const renderWithProviders: (ui: React.ReactElement, options?: {
    queryClient?: QueryClient;
    authContext?: AuthContextType;
...
export declare const renderWithGuestContext: (ui: React.ReactElement, options?: RenderOptions) => import("@testing-library/react").RenderResult<typeof import("@testing-library/dom/types/queries"), HTMLElement, HTMLElement>;
export {};
