...
const prompts = [
    { input: "Propose-moi trois créneaux mardi ou mercredi prochain pour la démo client.", description: "Démo client mardi/mercredi", minDates: 2 },
    { input: "Planifie un point budget dans deux semaines autour de 9h30.", description: "Point budget dans deux semaines", minDates: 1 },
    { input: "Génère une réunion projet la semaine du 18, plutôt en fin de journée.", description: "Réunion projet semaine du 18", minDates: 2 },
    { input: "Trouve un créneau avant vendredi midi pour passer en revue les slides.", description: "Revue slides avant vendredi midi", minDates: 1 },
    { input: "Organise un stand-up express demain matin pour l'équipe support.", description: "Stand-up express demain matin", minDates: 1 },
];
