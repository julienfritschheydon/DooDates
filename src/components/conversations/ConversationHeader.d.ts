...
export declare function ConversationHeader({ conversation, language, onResume, onViewPoll, compact, className, }: ConversationHeaderProps): import("react/jsx-runtime").JSX.Element;
