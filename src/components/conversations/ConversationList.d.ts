...
export declare function ConversationList({ conversations, isLoading, error, onResume, onRename, onDelete, onToggleFavorite, onViewPoll, onCreateNew, language, showSearch, compact, className, height, }: ConversationListProps): import("react/jsx-runtime").JSX.Element;
