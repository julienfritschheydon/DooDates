...
describe('ConversationPreview', () => {
  ...
  describe('Messages Display', () => {
    ...
    it('displays message timestamps', () => {
      ...
      const timeElements = screen.getAllByText(/Il y a|À l'instant/);
  ...
  describe('Message Navigation', () => {
    ...
    it('navigates to previous message when previous button is clicked', async () => {
      ...
      // Then go back
      const prevButton = screen.getByText('Message précédent');
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('shows keyboard shortcuts help text', () => {
      ...
      expect(screen.getByText('Utilisez Ctrl+↑/↓ pour naviguer, Échap pour fermer')).toBeInTheDocument();
    });
  });
  ...
  describe('Language Support', () => {
    ...
    it('shows English keyboard shortcuts help', () => {
      ...
      expect(screen.getByText('Use Ctrl+↑/↓ to navigate, Esc to close')).toBeInTheDocument();
    });
