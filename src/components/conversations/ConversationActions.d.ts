...
export declare function ConversationActions({ conversation, onResume, onRename, onDelete, onToggleFavorite, onToggleArchive, onViewPoll, onShare, onExport, inline, compact, language, className, }: ConversationActionsProps): import("react/jsx-runtime").JSX.Element;
