...
export declare function ConversationPreview({ conversation, isOpen, onClose, onResume, onViewPoll, language, className, }: ConversationPreviewProps): import("react/jsx-runtime").JSX.Element;
