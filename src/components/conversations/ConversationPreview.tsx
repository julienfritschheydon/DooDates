    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-gray-600">
        <div className="flex items-center gap-2">
          ...
          <span>{conversation.messageCount} {text.messages}</span>
        </div>
        <div className="flex items-center gap-2">
          <Calendar className="h-4 w-4" />
          <span>
            {text.createdOn} {conversation.createdAt.toLocaleDateString(
...
export function ConversationPreview({
  ...
  const text = {
    ...
    noMessages: language === 'fr' ? 'Aucun message dans cette conversation.' : 'No messages in this conversation.',
