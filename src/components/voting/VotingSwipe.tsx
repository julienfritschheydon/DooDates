        ...
        <div className="flex items-center justify-center p-4 min-h-[calc(100vh-80px)]">
          ...
          >
            ...
            <p className="opacity-90 mb-6">
              Merci {voterInfo.name} pour votre participation
            </p>
            <button
              onClick={onBack}
        ...
        <div className="flex items-center justify-center p-4 min-h-[calc(100vh-80px)]">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              {(!voterInfo.name.trim() || !voterInfo.email.trim()) &&
                !formErrors.general && (
              ...
              <p className="text-xs text-gray-400 text-center">
                Vos informations restent privées et ne seront utilisées que pour
                ce sondage
              </p>
            </div>
          </motion.div>
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex justify-center gap-2 sm:gap-4 mt-4 mb-4">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-full px-3 py-1.5 flex items-center gap-1.5">
            ...
            <span className="text-orange-800 font-medium text-sm">
              {formatExpiryDate(mockPoll.expires_at)}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 space-y-3 py-6">
        ...
        {swipeOptions.map((option, index) => {
          ...
          if (index === 0) {
            console.log(
              "Première ligne - userHasVoted:",
              userHasVoted[option.id],
              "optionId:",
              option.id,
            );
            console.log(
              "Condition flèches:",
              index === 0 && !userHasVoted[option.id],
            );
          }
          ...
          return (
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2 relative">
                ...
                {index === 0 &&
                  !Object.values(userHasVoted).some((voted) => voted) &&
                  (() => {
                    console.log(
                      "🎯 Flèches affichées - index:",
                      index,
                      "aucun vote encore:",
                      !Object.values(userHasVoted).some((voted) => voted),
                    );
                ...
                <button
                  ...
                  className={`relative overflow-hidden rounded-lg p-3 transition-all border-2 ${
                    ...
                    (userVote === "yes" && userHasVoted[option.id]) ||
                    currentSwipe[option.id] === "yes"
                ...
                */}
                ...
                <button
                  ...
                  className={`relative overflow-hidden rounded-lg p-3 transition-all border-2 ${
                    ...
                    (userVote === "maybe" && userHasVoted[option.id]) ||
                    currentSwipe[option.id] === "maybe" ||
                    (!userHasVoted[option.id] && userVote === "maybe")
                ...
                >
                  ...
                  {(() => {
                    const totalVotants =
                      ...
                      getExistingStats(option.id).maybe +
                      getExistingStats(option.id).no;
                    const votesExistantsMaybe = getExistingStats(
                      option.id,
                    ).maybe;
                    const ajoutVoteUtilisateur = 1;
                ...
                <button
                  ...
                  className={`relative overflow-hidden rounded-lg p-3 transition-all border-2 ${
                    ...
                    (userVote === "no" && userHasVoted[option.id]) ||
                    currentSwipe[option.id] === "no"
