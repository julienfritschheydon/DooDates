...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  return (
    <Card className={`max-w-2xl mx-auto ${className}`}>
      <CardHeader>
        <CardTitle>{initialData ? "Modifier le produit" : "Créer un nouveau produit"}</CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Le titre sera visible par les participants</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
