...
import { MigrationProgress as MigrationProgressType, MigrationStatus } from '../lib/storage/ConversationMigrationService';
...
const statusConfig: Record<MigrationStatus, {
...
export function MigrationProgress({ 
  ...
  const conversationProgress = progress.totalConversations > 0 
  ...
  const isActive = ['in_progress', 'validating', 'uploading', 'verifying'].includes(progress.status);
          ...
          <div className="space-y-3 pt-2 border-t">
            {progress.totalConversations > 0 && (
              <div className="space-y-1">
                <div className="flex justify-between text-sm">
                  ...
                  <span>{progress.processedConversations}/{progress.totalConversations}</span>
                </div>
            ...
            {progress.totalMessages > 0 && (
              <div className="space-y-1">
                <div className="flex justify-between text-sm">
                  <span>Messages</span>
                  <span>{progress.processedMessages}/{progress.totalMessages}</span>
                </div>
