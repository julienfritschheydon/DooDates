...
export default function QuestionCard({ question, isActive, onEdit, onChange, onDuplicate, onDelete, onMoveUp, onMoveDown, allQuestions, conditionalRules, onConditionalRulesChange, }: QuestionCardProps): import("react/jsx-runtime").JSX.Element;
