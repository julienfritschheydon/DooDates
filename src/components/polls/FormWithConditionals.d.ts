 ...
 */
export default function FormWithConditionals({ title, questions, conditionalRules, onSubmit, respondentName, }: FormWithConditionalsProps): import("react/jsx-runtime").JSX.Element;
export {};
