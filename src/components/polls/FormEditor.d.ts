 ...
 */
export default function FormEditor({ value, onChange, onCancel, onAddQuestion, onSaveDraft, onFinalize, modifiedQuestionId, modifiedField, themeId, onThemeChange, simulationButton, }: FormEditorProps): import("react/jsx-runtime").JSX.Element;
