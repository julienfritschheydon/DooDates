...
export type AnyFormQuestion = SingleOrMultipleQuestion | TextQuestion | LongTextQuestion | MatrixQuestion | RatingQuestion | NPSQuestion;
...
export default function FormPollCreator({ initialDraft, onCancel, onSave, onFinalize, }: FormPollCreatorProps): import("react/jsx-runtime").JSX.Element;
export {};
