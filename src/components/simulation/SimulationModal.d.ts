...
export declare function SimulationModal({ pollId, detectedContext, userTier, onStart, onClose, remainingSimulations, }: SimulationModalProps): import("react/jsx-runtime").JSX.Element;
export {};
