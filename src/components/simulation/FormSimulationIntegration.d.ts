...
export declare function FormSimulationIntegration({ pollId, pollTitle, questions, userTier, buttonVariant, }: FormSimulationIntegrationProps): import("react/jsx-runtime").JSX.Element;
export {};
