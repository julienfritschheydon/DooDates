...
describe('CascadeDeleteModal', () => {
  ...
  describe('Traductions i18n', () => {
    it('should render in English when language is en', () => {
      ...
      expect(screen.getByText('You are about to permanently delete the following items:')).toBeInTheDocument();
  ...
  describe('Styles visuels', () => {
    ...
    it('should show items with correct styling', () => {
      ...
      const itemContainers = screen.getAllByText(/Réunion équipe du 15\/01|Disponibilités janvier/)
