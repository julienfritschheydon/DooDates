 ...
 */
export declare function ErrorMessage({ variant, title, message, className, action, }: ErrorMessageProps): import("react/jsx-runtime").JSX.Element;
/**
 ...
 */
export declare function FieldError({ message }: {
    message?: string;
}): import("react/jsx-runtime").JSX.Element;
export {};
