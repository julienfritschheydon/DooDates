...
export const ProductSidebar: React.FC<ProductSidebarProps> = ({
  ...
  const handleLinkClick = () => {
    if (onClose) onClose();
    // Toujours fermer la sidebar lors d'un clic sur un lien
    if (propOnToggle && isOpen) {
      // Si la sidebar est contrôlée par des props et qu'elle est ouverte, la fermer
      propOnToggle();
    } else if (!propOnToggle) {
      // Si la sidebar utilise l'état interne, la fermer directement
