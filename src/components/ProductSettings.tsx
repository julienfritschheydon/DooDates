...
import { Shield, Settings, FileText, Download, Trash2, Clock, Mail, Eye, Lock, AlertCircle } from "lucide-react";
            ...
            <div className="pt-20">
                <div className="max-w-4xl mx-auto px-4 py-8">
                    ...
                    <div className="text-center mb-8">
                        <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${getProductGradient()} rounded-full mb-4`}>
