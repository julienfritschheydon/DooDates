 ...
 */
export type CreditActionType = "conversation_created" | "poll_created" | "ai_message" | "analytics_query" | "simulation" | "other";
 ...
 */
export declare function getQuotaConsumed(userId: string | null | undefined): Promise<QuotaConsumedData>;
/**
 * Obtenir le journal de consommation pour un utilisateur
 */
export declare function getConsumptionJournal(userId: string | null | undefined, limit?: number): CreditJournalEntry[];
/**
 * Incrémenter le compteur de conversations créées
 */
export declare function incrementConversationCreated(userId: string | null | undefined, conversationId?: string): void;
/**
 * Incrémenter le compteur de polls créés
 */
export declare function incrementPollCreated(userId: string | null | undefined, pollId?: string): void;
/**
 * Consommer des crédits pour un message IA
 */
export declare function consumeAiMessageCredits(userId: string | null | undefined, conversationId?: string): void;
/**
 * Consommer des crédits pour une query analytics
 */
export declare function consumeAnalyticsCredits(userId: string | null | undefined, pollId?: string, query?: string): void;
/**
 * Consommer des crédits pour une simulation (5 crédits selon la doc)
 */
export declare function consumeSimulationCredits(userId: string | null | undefined, pollId?: string, simulationId?: string): void;
/**
 * Consommer des crédits pour une action personnalisée
 */
export declare function consumeCustomCredits(userId: string | null | undefined, credits: number, action: CreditActionType, metadata?: CreditJournalEntry["metadata"]): void;
/**
