...
export declare class EmailService {
    ...
    static sendPollCreated(pollTitle: string, pollSlug: string, creatorName: string, participantEmails: string[]): Promise<{
        success: boolean;
        error?: string;
    }>;
    static sendVoteNotification(pollTitle: string, pollSlug: string, creatorEmail: string, voterName: string): Promise<{
        success: boolean;
        error?: string;
    }>;
    static sendVoteConfirmation(pollTitle: string, pollSlug: string, voterName: string, voterEmail: string): Promise<{
        success: boolean;
        error?: string;
    }>;
    /**
     ...
     */
    static sendPollCreatedNotification(creatorEmail: string, pollTitle: string, pollSlug: string, selectedDates: string[]): Promise<{
        success: boolean;
        error?: string;
    }>;
}
