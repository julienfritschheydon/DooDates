 ...
 * Met à jour un tag
 */
export declare function updateTag(tagId: string, updates: Partial<Pick<Tag, "name" | "color">>): Tag;
/**
 * Supprime un tag
 */
 ...
 */
export declare function getTagUsageCount(tagName: string, allItems: {
    tags?: string[];
}[]): number;
