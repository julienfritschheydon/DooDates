                        ...
                        <Card className="bg-white dark:bg-card border-gray-200 dark:border-gray-700 shadow-sm">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="p-4 bg-gray-50 dark:bg-[#2a2a2a] rounded-lg border border-gray-200 dark:border-gray-700">
                                    <h3 className="text-gray-900 dark:text-white font-semibold mb-2">{publishedPoll.title}</h3>
                                    {publishedPoll.description && (
                                        <p className="text-gray-600 dark:text-gray-400 text-sm">{publishedPoll.description}</p>
                                    )}
                                </div>
                                ...
                                <TooltipProvider>
                                    <div>
                                        <Label className="text-gray-700 dark:text-gray-300 mb-2 block">Lien de partage :</Label>
