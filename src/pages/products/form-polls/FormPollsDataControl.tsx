...
export default function FormPollsDataControl() {
  ...
  const handleDeleteAllData = async () => {
    if (
      !confirm(
        "Êtes-vous sûr de vouloir supprimer TOUTES vos données de formulaires ? Cette action est irréversible.",
      )
    ) {
      return;
    }
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 mb-4">
                Téléchargez toutes vos données de formulaires au format JSON :
              </p>
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-red-800 text-sm">
                      Cette action supprimera tous vos formulaires et toutes les réponses
                      collectées.
                    </p>
                  </div>
                </div>
              ...
              <Button
                ...
                disabled={isDeleting}
                variant="destructive"
                data-testid="form-delete-all-data"
              >
