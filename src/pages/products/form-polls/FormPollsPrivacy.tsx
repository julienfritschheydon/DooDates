                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700">
                                DooDates - Formulaires & Sondages vous permet de créer des formulaires
                                personnalisés et collecter des réponses. Cette politique explique comment
                    ...
                    <div className="ml-10">
                        ...
                        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                            <p className="text-sm text-blue-900">
                                <strong>Important :</strong> Les réponses collectées via vos formulaires
                                vous appartiennent. Nous ne les utilisons pas à des fins commerciales et
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div className="ml-10">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2">
                            ...
                            <li><strong>Exporter</strong> vos formulaires et réponses (CSV, JSON)</li>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div className="ml-10">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2">
                            ...
                            <li>Comptes inactifs : supprimés après 2 ans d'inactivité (avec notification préalable)</li>
