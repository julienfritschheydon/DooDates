            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700">
                                DooDates - Sondages de Disponibilité vous permet de trouver les créneaux
                                horaires qui conviennent à tous les participants. Cette politique explique
                    ...
                    <div className="ml-10">
                        ...
                        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                            <p className="text-sm text-blue-900">
                                <strong>Important :</strong> Vos disponibilités personnelles ne sont visibles
                                que par l'organisateur du sondage. Nous ne vendons jamais vos données.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div className="ml-10">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2">
                            ...
                            <li><strong>Exporter</strong> vos données au format JSON</li>
                            <li><strong>Retirer</strong> vos disponibilités d'un sondage</li>
                        </ul>
                        <div className="mt-4">
                            <Button
                                onClick={() => navigate("/availability-polls/data-control")}
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="space-y-2 text-gray-700">
                        <p><strong>Email :</strong> privacy@doodates.com</p>
                        <p><strong>DPO :</strong> dpo@doodates.com</p>
                    </div>
                </div>
            </div>
        </div>
