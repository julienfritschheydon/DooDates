...
export default function AvailabilityPollsDataControl() {
  ...
  const handleExportData = async () => {
    ...
    try {
      toast({
        ...
        description: "Vos données de disponibilités sont en cours d'export...",
      });
      setTimeout(() => {
        toast({
  ...
  const handleDeleteAllData = async () => {
    if (
      !confirm(
        "Êtes-vous sûr de vouloir supprimer TOUTES vos données de disponibilités ? Cette action est irréversible.",
      )
    )
      return;
    setIsDeleting(true);
    try {
      toast({
        ...
        description: "Suppression de tous vos sondages de disponibilité...",
      });
      setTimeout(() => {
        toast({
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-800 text-sm">
                Contrôle total sur vos sondages de disponibilité et les réponses.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-red-800 text-sm">
                      Suppression définitive de tous vos sondages de disponibilité.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          <p>
            Pour toute question :{" "}
            <a
              href="mailto:availability-privacy@doodates.com"
              className="text-blue-600 hover:underline"
            >
              availability-privacy@doodates.com
            </a>
          </p>
        </div>
      </div>
