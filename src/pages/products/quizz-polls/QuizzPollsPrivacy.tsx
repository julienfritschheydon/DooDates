                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700">
                                DooDates - Quiz & Évaluations vous permet de créer des quiz, questionnaires
                                et évaluations. Cette politique explique comment nous collectons, utilisons
                    ...
                    <div className="ml-10">
                        ...
                        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                            <p className="text-sm text-blue-900">
                                <strong>Important :</strong> Les résultats des quiz vous appartiennent.
                                Nous ne les utilisons pas à des fins commerciales et ne les partageons
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div className="ml-10">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2">
                            ...
                            <li><strong>Exporter</strong> vos quiz et résultats (CSV, JSON)</li>
                            <li><strong>Demander</strong> la suppression de vos résultats à un quiz</li>
                        </ul>
                        <div className="mt-4">
                            <Button
