...
export default function QuizzPollsDataControl() {
    ...
    const handleExportData = async () => {
        setIsExporting(true);
        try {
            toast({ title: "Export en cours", description: "Vos données de quiz sont en cours d'export..." });
            setTimeout(() => {
    ...
    const handleDeleteAllData = async () => {
        if (!confirm("Êtes-vous sûr de vouloir supprimer TOUS vos quiz et résultats ? Cette action est irréversible.")) return;
        setIsDeleting(true);
        try {
            toast({ title: "Suppression en cours", description: "Suppression de tous vos quiz..." });
            setTimeout(() => {
                toast({ title: "Données supprimées", description: "Toutes vos données de quiz ont été supprimées." });
                setIsDeleting(false);
            }, 2000);
        } catch (error) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="max-w-4xl mx-auto px-4 py-8">
                <div className="mb-8">
                    <Button variant="ghost" onClick={() => navigate("/quizz-polls/dashboard")} className="mb-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-blue-800 text-sm">Contrôle total sur vos quiz et les résultats des participants.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                            ...
                            <ul className="list-disc list-inside text-gray-700 space-y-1 mb-4">
                                <li>Tous vos quiz créés</li>
                                <li>Questions et réponses correctes</li>
                                <li>Résultats des participants</li>
                            ...
                            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                                <div className="flex items-start gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-red-800 text-sm">Suppression définitive de tous vos quiz et résultats.</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="space-y-2">
                        <Button variant="ghost" onClick={() => navigate("/quizz-polls/privacy")} className="w-full justify-start">Politique de confidentialité</Button>
                        <Button variant="ghost" onClick={() => navigate("/quizz-polls/settings")} className="w-full justify-start">Paramètres du compte</Button>
                    </div>
                </div>
