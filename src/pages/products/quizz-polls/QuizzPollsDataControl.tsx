...
export default function QuizzPollsDataControl() {
  ...
  const handleExportData = async () => {
    ...
    try {
      toast({
        ...
        description: "Vos données de quiz sont en cours d'export...",
      });
      setTimeout(() => {
        toast({
  ...
  const handleDeleteAllData = async () => {
    if (
      !confirm(
        "Êtes-vous sûr de vouloir supprimer TOUS vos quiz et résultats ? Cette action est irréversible.",
      )
    )
      return;
    setIsDeleting(true);
    try {
      ...
      setTimeout(() => {
        toast({
          ...
          description: "Toutes vos données de quiz ont été supprimées.",
        });
        setIsDeleting(false);
      }, 2000);
    } catch (error) {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-800 text-sm">
                Contrôle total sur vos quiz et les résultats des participants.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-red-800 text-sm">
                      Suppression définitive de tous vos quiz et résultats.
                    </p>
                  </div>
                </div>
              </div>
              <Button
                ...
                disabled={isDeleting}
                variant="destructive"
                data-testid="quizz-delete-all-data"
              >
