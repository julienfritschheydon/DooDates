...
export default function DatePollsDataControl() {
  ...
  const handleDeleteAllData = async () => {
    if (
      !confirm(
        "Êtes-vous sûr de vouloir supprimer TOUTES vos données de sondages de dates ? Cette action est irréversible.",
      )
    ) {
      return;
    }
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="bg-blue-900/30 border border-blue-700/50 rounded-lg p-6 mb-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-lg font-semibold text-blue-300 mb-2">Vos droits RGPD</h2>
                <p className="text-blue-200 text-sm">
                  Conformément au Règlement Général sur la Protection des Données (RGPD), vous avez
                  un contrôle total sur vos données personnelles. Cette page vous permet d'exercer
                  vos droits.
                </p>
              </div>
            </div>
          ...
          <div className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-6 mb-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-semibold text-white mb-2">Exporter mes données</h2>
                <p className="text-gray-300 mb-4">
                  Téléchargez toutes vos données de sondages de dates au format JSON. Cela inclut :
                </p>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-red-800 text-sm">
                        Cette action supprimera définitivement tous vos sondages de dates, votes
                        reçus, et données associées. Cette opération ne peut pas être annulée.
                      </p>
                    </div>
                  </div>
                </div>
                <p className="text-gray-300 mb-4">Seront supprimés :</p>
                <ul className="list-disc list-inside text-gray-300 space-y-1 mb-4">
          ...
          <div className="mt-6 text-center text-sm text-gray-400">
            <p>
              ...
              <a href="mailto:date-privacy@doodates.com" className="text-blue-600 hover:underline">
                date-privacy@doodates.com
              </a>
            </p>
          </div>
        </div>
