                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-300">
                                DooDates - Sondages de Dates vous permet de créer et gérer des sondages pour
                                trouver les meilleures dates pour vos événements. Cette politique explique
                    ...
                    <div className="ml-10">
                        ...
                        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                            <p className="text-sm text-blue-900">
                                ...
                                Vos sondages de dates restent privés sauf si vous choisissez de les partager.
                            </p>
                        </div>
                    </div>
                </div>
