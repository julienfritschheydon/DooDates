            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  des services du site DooDates. Tout accès et/ou utilisation du site suppose
                  l'acceptation et le respect de l'ensemble des termes des présentes conditions et
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  DooDates fournit des outils de planification collaborative, de création de
                  sondages, de formulaires et de quiz, assistés par une Intelligence Artificielle.
                </p>
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed">
                  <p>
                    L'utilisateur est responsable de l'utilisation qu'il fait des informations et
                    outils mis à disposition sur le site. Il s'engage à ne pas utiliser les services
                    à des fins illégales ou nuisibles.
                  </p>
                  <p>
                    DooDates s'efforce d'assurer la fiabilité et la mise à jour des informations
                    diffusées sur le site, mais ne garantit pas l'absence d'erreurs ou d'omissions.
                  </p>
                  <p>
                    L'utilisation de l'IA (Gemini) est soumise à des limitations inhérentes à la
                    technologie (hallucinations possibles, erreurs factuelles). L'utilisateur doit
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed mb-3">
                  L'ensemble des éléments du site (textes, graphismes, logiciels, logos, sons,
                  marques, etc.) est la propriété exclusive de DooDates ou de ses partenaires.
                </p>
                <p className="text-gray-300 leading-relaxed">
                  Toute reproduction ou représentation, totale ou partielle, sans l'accord de
                  DooDates, est interdite et constituerait une contrefaçon sanctionnée par le Code
