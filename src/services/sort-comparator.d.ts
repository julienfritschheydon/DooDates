 ...
 */
export declare function compareUnifiedItems<T extends UnifiedItem>(a: T, b: T, options?: SortOptions): number;
/**
 * Trie un tableau de conversations avec gestion des favoris
 */
export declare function sortConversations(conversations: Conversation[], options?: Partial<SortOptions>): Conversation[];
/**
 * Met à jour le favorite_rank d'une conversation
 */
export declare function updateFavoriteRank(conversations: Conversation[], conversationId: string, newRank: number): Conversation[];
/**
