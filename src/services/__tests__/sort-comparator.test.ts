...
describe('sort-comparator', () => {
  ...
  describe('updateFavoriteRank', () => {
    it('should update favorite rank and set isFavorite to true', () => {
      const conversations = [
        ...
        createMockConversation({ id: 'conv2', isFavorite: true, favorite_rank: 1 })
      ];
  ...
  describe('reorderFavoriteRanks', () => {
    ...
    it('should preserve non-favorite conversations', () => {
      const conversations = [
        createMockConversation({ id: 'conv1', isFavorite: true, favorite_rank: 1 }),
  ...
  describe('getNextFavoriteRank', () => {
    ...
    it('should return next available rank', () => {
      const conversations = [
        createMockConversation({ id: 'conv1', isFavorite: true, favorite_rank: 1 }),
        createMockConversation({ id: 'conv2', isFavorite: true, favorite_rank: 3 }),
        createMockConversation({ id: 'conv3', isFavorite: false })
      ];
    ...
    it('should handle favorites without ranks', () => {
      const conversations = [
        createMockConversation({ id: 'conv1', isFavorite: true, favorite_rank: undefined }),
        createMockConversation({ id: 'conv2', isFavorite: true, favorite_rank: 2 })
      ];
  ...
  describe('validateFavoriteRanks', () => {
    ...
    it('should detect favorites without ranks', () => {
      const conversations = [
        createMockConversation({ id: 'conv1', isFavorite: true, favorite_rank: 1 }),
        createMockConversation({ id: 'conv2', isFavorite: true, favorite_rank: undefined })
      ];
    ...
    it('should suggest fixing gaps in rank sequence', () => {
      const conversations = [
        createMockConversation({ id: 'conv1', isFavorite: true, favorite_rank: 1 }),
        createMockConversation({ id: 'conv2', isFavorite: true, favorite_rank: 5 }) // Gap: 2,3,4 missing
      ];
  ...
  describe('Edge cases', () => {
    ...
    it('should handle items with same timestamps', () => {
      ...
      const item1 = createMockItem({ id: 'item1', updatedAt: sameDate, title: 'Alpha' });
      const item2 = createMockItem({ id: 'item2', updatedAt: sameDate, title: 'Beta' });
