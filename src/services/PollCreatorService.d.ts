...
export declare class PollCreatorService {
     ...
     */
    static handleFinalize(state: PollCreationState, createPoll: (pollData: PollData) => Promise<string>, onPollCreated?: (slug: string) => void): Promise<void>;
    /**
     * Toggle date selection
     */
    static toggleDate(dateString: string, selectedDates: string[], setState: (updater: (prev: PollCreationState) => PollCreationState) => void): void;
    /**
     ...
     */
    static handleGranularityChange(newGranularity: number, setState: (updater: (prev: PollCreationState) => PollCreationState) => void): void;
    /**
     ...
     */
    static undoGranularityChange(setState: (updater: (prev: PollCreationState) => PollCreationState) => void): void;
    /**
     ...
     */
    static getVisibleTimeSlots(dateString: string, timeSlots: TimeSlot[], showExtendedHours: boolean): TimeSlot[];
    /**
     ...
     */
    static toggleTimeSlotForDate(dateString: string, hour: number, minute: number, setState: (updater: (prev: PollCreationState) => PollCreationState) => void): void;
    /**
