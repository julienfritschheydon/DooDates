      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Voyez qui a répondu et qui n'a pas encore. Envoyez des rappels automatiques aux
                  retardataires.
                </p>
              </div>
            </div>
        ...
        <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-8 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h4 className="font-medium mb-2">Puis-je voir qui n'a pas encore répondu ?</h4>
              <p className="text-sm text-gray-400">
                Oui, le tableau de bord affiche la liste des participants et leur statut (répondu /
                en attente). Vous pouvez envoyer des rappels.
              </p>
            </div>
            <div>
              <h4 className="font-medium mb-2">Comment gérer plusieurs fuseaux horaires ?</h4>
              <p className="text-sm text-gray-400">
                Chaque participant voit les créneaux dans son fuseau horaire local. Le créateur peut
                aussi spécifier un fuseau de référence.
              </p>
            </div>
            <div>
