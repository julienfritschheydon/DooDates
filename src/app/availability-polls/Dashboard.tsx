...
import { MessageSquare, Info, Trash2, ExternalLink, Clock, FileText } from "lucide-react";
...
const AvailabilityPollsDashboard: React.FC = () => {
    const navigate = useNavigate();
    const [filter, setFilter] = useState<FilterType>("all");
    const contentTypeFilter = "availability";
        ...
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-gray-400">
                    Gérez vos sondages de disponibilité.
                </p>
            </div>
        </div>
    );
            ...
            <div className="pt-4">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <DashboardFilters
                        ...
                        contentTypeFilter="availability"
                    ...
                    {filteredItems.length === 0 ? (
                        <div className="text-center py-12 bg-gray-800 rounded-lg border border-gray-700 mt-6">
                            ...
                            <h3 className="text-xl font-medium text-white mb-2">
                                {searchQuery || filter !== "all" ? "Aucun résultat" : "Aucune disponibilité"}
                            </h3>
                            <p className="text-gray-400 mb-6">
                                {searchQuery || filter !== "all"
                                    ? "Essayez avec d'autres critères"
                                    : "Créez votre première disponibilité pour commencer"}
                            </p>
                            <button
...
export default AvailabilityPollsDashboard;
