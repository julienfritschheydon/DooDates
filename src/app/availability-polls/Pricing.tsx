                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-400">
                            Synchronisez vos équipes en toute simplicité
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <div className="bg-[#1a1a1a] rounded-2xl p-8 border border-emerald-900/30">
                            ...
                            <button className="w-full py-3 px-6 bg-emerald-900/30 text-emerald-400 rounded-lg font-medium hover:bg-emerald-900/50 transition-colors">
                        ...
                        <div className="bg-gradient-to-br from-emerald-900/20 to-emerald-800/20 rounded-2xl p-8 border-2 border-emerald-500 relative">
                            ...
                            <button className="w-full py-3 px-6 bg-emerald-600 text-white rounded-lg font-medium hover:bg-emerald-700 transition-colors">
                                Passer à Pro
                            </button>
                        </div>
