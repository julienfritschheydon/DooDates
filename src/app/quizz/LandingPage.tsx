          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-center text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-12 leading-relaxed">
                Importez une photo ou un PDF de devoir, l'IA génère un quiz interactif. Votre enfant
                répond, reçoit un feedback immédiat et un score encourageant.
              </p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 max-w-xl mx-auto">
                Plus besoin de corriger à la main. L'IA fait le travail, vous profitez du temps
                gagné.
              </p>
            </div>
