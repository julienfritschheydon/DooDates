...
export const PRODUCT_CONFIGS: Record<ProductType, ProductConfig> = {
  date: {
    ...
    dashboardRoute: "/date/dashboard",
    listRoute: "/date/dashboard",
    settingsRoute: "/date/settings",
    pricingRoute: "/date/pricing",
    docsRoute: "/date/docs",
    journalRoute: "/date/journal",
  ...
  form: {
    ...
    dashboardRoute: "/form/dashboard",
    listRoute: "/form/dashboard",
    settingsRoute: "/form/settings",
    pricingRoute: "/form/pricing",
    docsRoute: "/form/docs",
    journalRoute: "/form/journal",
  ...
  availability: {
    ...
    dashboardRoute: "/availability/dashboard",
    listRoute: "/availability/dashboard",
    settingsRoute: "/availability/settings",
    pricingRoute: "/availability/pricing",
    docsRoute: "/availability/docs",
    journalRoute: "/availability/journal",
