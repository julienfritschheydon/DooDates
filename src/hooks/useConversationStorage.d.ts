import { Conversation, ConversationMessage, ConversationError, StorageProvider } from "../types/conversation";
/**
...
export declare function useConversationStorage(config?: UseConversationStorageConfig): {
    ...
    useConversation: (conversationId: string) => import("@tanstack/react-query").UseQueryResult<any, Error>;
    useMessages: (conversationId: string) => import("@tanstack/react-query").UseQueryResult<any, Error>;
    createConversation: {
        mutate: import("@tanstack/react-query").UseMutateFunction<any, Error, Omit<Conversation, "id" | "createdAt" | "updatedAt">, unknown>;
        mutateAsync: import("@tanstack/react-query").UseMutateAsyncFunction<any, Error, Omit<Conversation, "id" | "createdAt" | "updatedAt">, unknown>;
        isLoading: boolean;
        isError: boolean;
        error: ConversationError | undefined;
        isSuccess: boolean;
    ...
    deleteConversation: {
        ...
        mutateAsync: import("@tanstack/react-query").UseMutateAsyncFunction<string, Error, string, unknown>;
        isLoading: boolean;
        isError: boolean;
        error: ConversationError | undefined;
        isSuccess: boolean;
    ...
    addMessage: {
        mutate: import("@tanstack/react-query").UseMutateFunction<ConversationMessage, Error, {
            conversationId: string;
            message: ConversationMessage;
        }, unknown>;
        mutateAsync: import("@tanstack/react-query").UseMutateAsyncFunction<ConversationMessage, Error, {
            conversationId: string;
            message: ConversationMessage;
        }, unknown>;
        isLoading: boolean;
