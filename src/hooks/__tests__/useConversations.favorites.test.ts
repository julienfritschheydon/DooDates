...
describe('useConversations - Favorites Sorting', () => {
  ...
  describe('Tri par favoris', () => {
    it('should place favorites at the top of the list', async () => {
      const conversations = [
        createMockConversation('conv1', 'Conversation normale 1', false, undefined, new Date('2024-01-03')),
        createMockConversation('conv2', 'Conversation favorite', true, 1, new Date('2024-01-01')),
        createMockConversation('conv3', 'Conversation normale 2', false, undefined, new Date('2024-01-02')),
      ];
    ...
    it('should handle favorites without favorite_rank', async () => {
      const conversations = [
        ...
        createMockConversation('conv2', 'Favori sans rang', true, undefined, new Date('2024-01-02')),
        createMockConversation('conv3', 'Autre favori sans rang', true, undefined, new Date('2024-01-01')),
      ];
  ...
  describe('Tri par activité pour non-favoris', () => {
    it('should sort non-favorites by activity (updatedAt + messageCount)', async () => {
      ...
      const conversations = [
        createMockConversation('conv1', 'Ancienne avec peu de messages', false, undefined, baseDate),
        createMockConversation('conv2', 'Récente avec peu de messages', false, undefined, new Date('2024-01-03')),
        createMockConversation('conv3', 'Ancienne avec beaucoup de messages', false, undefined, baseDate),
      ];
  ...
  describe('Vérifications de cohérence', () => {
    it('should maintain favorites at top regardless of other sorting', async () => {
      const conversations = [
        createMockConversation('conv1', 'Z - Non favori récent', false, undefined, new Date('2024-01-03')),
    ...
    it('should handle empty favorite_rank gracefully', async () => {
      const conversations = [
        createMockConversation('conv1', 'Favori sans rang 1', true, undefined, new Date('2024-01-02')),
        createMockConversation('conv2', 'Favori sans rang 2', true, undefined, new Date('2024-01-01')),
