          ...
          if (shouldRegenerateTitle(conversation.title, hasCustomTitle, messages.length)) {
            ...
            if (titleResult.success) {
              try {
                ...
                await TitleService.updateEntityTitle(
                  "conversation",
                  conversationId,
                  titleResult.title,
                );
                ...
                if (conversation.pollId) {
                  try {
                    ...
                    logger.error("Erreur lors de la mise à jour du titre du poll", "general", {
                      pollId: conversation.pollId,
                      error: pollError,
                    });
                  }
                ...
                logger.error("Erreur lors de la mise à jour du titre", "conversation", error);
              }
            } else {
