...
const REGRESSION_THRESHOLD_E2E = 0.20; // 20% for E2E performance tests
...
function main() {
  ...
  if (regressions.length > 0) {
    console.log(`🚨 Found ${regressions.length} performance regression(s) > ${Math.round(REGRESSION_THRESHOLD_E2E * 100)}%`);
