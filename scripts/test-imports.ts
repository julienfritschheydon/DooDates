...
async function testWrappers() {
  ...
  try {
    ...
    const required = ['getPolls', 'addPoll', 'deletePollById', 'getPollBySlugOrId', 'savePolls', 'validatePoll', 'isDatePoll'];
  ...
  try {
    ...
    const required = ['getPolls', 'addPoll', 'deletePollById', 'getPollBySlugOrId', 'savePolls', 'validatePoll', 'isFormPoll', 'addFormResponse', 'getFormResponses', 'getFormResults'];
  ...
  try {
    ...
    const required = ['getPolls', 'addPoll', 'deletePollById', 'getPollBySlugOrId', 'savePolls', 'validatePoll', 'isQuizz'];
...
async function testPollStorageImport() {
  ...
  try {
    ...
    const required = ['getPolls', 'getAllPolls', 'addPoll', 'deletePollById', 'getPollBySlugOrId', 'savePolls'];
