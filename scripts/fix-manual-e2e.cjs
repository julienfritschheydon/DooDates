...
const manualFixes = [
  {
    ...
    replace: "await page.goto(`form-polls/${pollSlug}/results`, { waitUntil: 'domcontentloaded' });"
  },
  {
    file: 'tests/e2e/tags-folders.spec.ts',
    line: 86,
    find: "const conversationCard = await waitForElementReady(page, '[data-testid='poll-item']', {",
    replace: "const conversationCard = await waitForElementReady(page, '[data-testid=\"poll-item\"]', {"
  },
  {
    ...
    replace: "const titleSelector = 'input[placeholder*=\"Planification\"], input[placeholder*=\"titre\" i], [data-testid=\"poll-title\"]';"
  },
  {
  ...
  },
  {
    ...
    replace: "const finalizeBtn = await waitForElementReady(page, 'button:has-text(\"Publier le sondage\")', {"
  },
  {
    ...
    replace: "const formTitle = page.locator('input[placeholder*=\"titre\" i], input[name*=\"title\"], [data-testid=\"quizz-title\"]').first();"
  },
  {
  ...
  },
  {
    ...
    replace: "await page.goto(`/quizz/${MOCK_QUIZZ.slug}/vote`, { waitUntil: \"domcontentloaded\" });"
  }
];
