...
const testCases = [
    ...
    { input: "Crée un sondage pour un week-end jeux. Ajoute tous les samedis de mars 2026", expected: "mars 2026" },
    ...
    { input: "Trouve un après-midi libre la semaine prochaine pour la visite au musée.", expected: "semaine prochaine" },
    { input: "Bloque un créneau vendredi soir ou samedi matin pour un footing.", expected: "vendredi ou samedi" },
];
...
testCases.forEach((testCase, index) => {
    ...
    try {
        ...
        if (parsed.length === 0) {
            ...
            const matchesExpected = detectedText.toLowerCase().includes(testCase.expected.toLowerCase()) ||
