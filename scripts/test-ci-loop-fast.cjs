 ...
 * Utilise le serveur existant et un port différent
 */
...
console.log('🔧 Utilise le serveur existant sur port 8080');
...
function runTest() {
  ...
  // Utiliser reuseExistingServer:!true pour utiliser le serveur existant
