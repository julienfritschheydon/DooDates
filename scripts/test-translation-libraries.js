...
console.log(`Manuel: ${manualSuccess}/${results.length} (${Math.round(manualSuccess/results.length*100)}%)`);
console.log(`Gemini: ${geminiSuccess}/${results.length} (${Math.round(geminiSuccess/results.length*100)}%)`);
console.log(`Librairie: ${librarySuccess}/${results.length} (${Math.round(librarySuccess/results.length*100)}%)\n`);
